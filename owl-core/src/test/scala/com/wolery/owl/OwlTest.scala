...
class OwlTest extends OwlSuite
{
  ...
  test("isBetween")
  {
    assert(0.isBetween(0,1),          "[1]")
    assert(1.isBetween(0,1),          "[2]")
    reject(2.isBetween(0,1),          "[3]")
    assert(0.0.isBetween(0.0,1.0),    "[1]")
    assert(1.0.isBetween(0.0,1.0),    "[2]")
    reject(2.0.isBetween(0.0,1.0),    "[3]")
  }
